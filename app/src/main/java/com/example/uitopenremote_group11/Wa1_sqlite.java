...
import com.example.uitopenremote_group11.Adapter.Wa1_adapter;
...
public class Wa1_sqlite extends AppCompatActivity {
    APIInterface apiInterface;
    Wa1_helper db = new Wa1_helper(this);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wa1_sqlite);

        getWindow().setStatusBarColor(ContextCompat.getColor(Wa1_sqlite.this, R.color.my_orange));

        lv_assetData = (ListView) findViewById(R.id.assetData_lv);
        assetDataArrayList = new ArrayList<>();

        adapter = new Wa1_adapter(this, R.layout.item_wa1, assetDataArrayList);
        ...
        Cursor dataAsset1 = db.GetData("SELECT * FROM WEATHER");
