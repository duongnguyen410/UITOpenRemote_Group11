...
public class Wa2_adapter extends BaseAdapter {
    private final Context context;
    private final int layout;
    private final List<Asset_data> as_dataList;

    public Wa2_adapter(Context context, int layout, List<Asset_data> as_dataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        Wa2_adapter.ViewHolder holder;

        if(view == null){
            holder = new Wa2_adapter.ViewHolder();
            ...
            holder = (Wa2_adapter.ViewHolder) view.getTag();
        }
