...
public class Wa3_adapter extends BaseAdapter {
    private Context context;
    private int layout;
    private List<Asset_data> as_dataList;

    public Wa3_adapter(Context context, int layout, List<Asset_data> as_dataList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        Wa3_adapter.ViewHolder holder;

        if(view == null){
            holder = new Wa3_adapter.ViewHolder();
            ...
            holder = (Wa3_adapter.ViewHolder) view.getTag();
        }
        ...
        holder.subItem.setText("Id: " + assetData.getId() + " / Name: " + assetData.getName() + " / Temperature: " + assetData.getTemperature()
                + " / Temp_timestamp: " + assetData.getTemp_Timestamp() + " / Humidity: " + assetData.getHumidity() + " / Hum_timestamp: " + assetData.getHum_timestamp()
                + " / WindSpeed: " + assetData.getWindSpeed() + " / WindS_timestamp: " + assetData.getWindS_timestamp()
