...
public class Wa2_graph extends AppCompatActivity {
    GraphView graphView;
    ...
    Wa2_helper wa2_helper;
    SQLiteDatabase db;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wa2_graph);

        getWindow().setStatusBarColor(ContextCompat.getColor(Wa2_graph.this, R.color.my_orange));
        ...
        wa2_helper = new Wa2_helper(this);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                ...
                if(spinner_text.equals("Dec, 2022")){
                    ...
                    Cursor cursor = wa2_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='12' AND Year='2022'");
                    cursor.moveToFirst();
                    ...
                    Cursor cursor2 = wa2_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='12' AND Year='2022'");
                    cursor2.moveToFirst();
                    ...
                    Cursor cursor3 = wa2_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='12' AND Year='2022'");
                    cursor3.moveToFirst();
                ...
                if (spinner_text.equals("Jan, 2023")){
                    ...
                    graphView.removeAllSeries();
                    series = new LineGraphSeries<>();
                    Cursor cursor = wa2_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='01' AND Year='2023'");
                    cursor.moveToFirst();
                    for(int i=0; i<cursor.getCount();i++){
                        series.appendData(new DataPoint(Long.parseLong(cursor.getString(8)), Float.parseFloat(cursor.getString(2))), true, 50);
                        cursor.moveToNext();
                    ...
                    graphView2.removeAllSeries();
                    series2 = new LineGraphSeries<>();
                    Cursor cursor2 = wa2_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='01' AND Year='2023'");
                    cursor2.moveToFirst();
                    for(int i=0; i<cursor2.getCount();i++){
                        series2.appendData(new DataPoint(Long.parseLong(cursor2.getString(8)), Float.parseFloat(cursor2.getString(4))), true, 50);
                        cursor2.moveToNext();
                    ...
                    graphView3.removeAllSeries();
                    series3 = new LineGraphSeries<>();
                    Cursor cursor3 = wa2_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='01' AND Year='2023'");
                    cursor3.moveToFirst();
                    for(int i=0; i<cursor3.getCount();i++){
                        series3.appendData(new DataPoint(Long.parseLong(cursor3.getString(8)), Float.parseFloat(cursor3.getString(6))), true, 50);
                        cursor3.moveToNext();
