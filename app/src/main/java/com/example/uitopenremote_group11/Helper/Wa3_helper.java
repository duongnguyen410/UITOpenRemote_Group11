...
public class Wa3_helper extends SQLiteOpenHelper {
    private static final int DATABASE_VERSION = 1;

    // Asset table name
    private static final String TABLE_ASSET = "WEATHER3";
    ...
    public Wa3_helper(Context context) {
    ...
    public void deleteAssetData(String date){
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("DELETE FROM WEATHER3 WHERE Date=?", new String[]{date});
    }
