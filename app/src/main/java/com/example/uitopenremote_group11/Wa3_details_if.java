...
public class Wa3_details_if extends AppCompatActivity {
    TextView hum_value;
    TextView temp_value ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_wa3_details_if);

        getWindow().setStatusBarColor(ContextCompat.getColor(Wa3_details_if.this, R.color.my_orange));
