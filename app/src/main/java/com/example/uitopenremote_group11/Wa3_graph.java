...
public class Wa3_graph extends AppCompatActivity {
    GraphView graphView;
    ...
    Wa3_helper wa3_helper;
    SQLiteDatabase db;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_wa3_graph);

        getWindow().setStatusBarColor(ContextCompat.getColor(Wa3_graph.this, R.color.my_orange));
        ...
        wa3_helper = new Wa3_helper(this);
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long l) {
                ...
                if(spinner_text.equals("Dec, 2022")){
                    ...
                    Cursor cursor = wa3_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='12' AND Year='2022'");
                    cursor.moveToFirst();
                    ...
                    Cursor cursor2 = wa3_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='12' AND Year='2022'");
                    cursor2.moveToFirst();
                    ...
                    Cursor cursor3 = wa3_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='12' AND Year='2022'");
                    cursor3.moveToFirst();
                ...
                if (spinner_text.equals("Jan, 2023")){
                    ...
                    graphView.removeAllSeries();
                    series = new LineGraphSeries<>();
                    Cursor cursor = wa3_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='01' AND Year='2023'");
                    cursor.moveToFirst();
                    for(int i=0; i<cursor.getCount();i++){
                        series.appendData(new DataPoint(Long.parseLong(cursor.getString(8)), Float.parseFloat(cursor.getString(2))), true, 50);
                        cursor.moveToNext();
                    ...
                    graphView2.removeAllSeries();
                    series2 = new LineGraphSeries<>();
                    Cursor cursor2 = wa3_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='01' AND Year='2023'");
                    cursor2.moveToFirst();
                    for(int i=0; i<cursor2.getCount();i++){
                        series2.appendData(new DataPoint(Long.parseLong(cursor2.getString(8)), Float.parseFloat(cursor2.getString(4))), true, 50);
                        cursor2.moveToNext();
                    ...
                    graphView3.removeAllSeries();
                    series3 = new LineGraphSeries<>();
                    Cursor cursor3 = wa3_helper.GetData("SELECT * FROM WEATHER2 WHERE Month='01' AND Year='2023'");
                    cursor3.moveToFirst();
                    for(int i=0; i<cursor3.getCount();i++){
                        series3.appendData(new DataPoint(Long.parseLong(cursor3.getString(8)), Float.parseFloat(cursor3.getString(6))), true, 50);
                        cursor3.moveToNext();
